...
public class RoboticDogTest {
	...
	public void shouldHaveDryness80() {
		Robotic underTest = new RoboticDog("", "", 100, 0, 80);
	...
	public void shouldHaveDryness0() {
		Robotic underTest = new RoboticDog("", "", 0, 0, 0);
		int dryness = underTest.getDryness();
	...
	public void shouldHaveHealth100() {
		Pet underTest = new RoboticDog("", "", 100, 0, 80);
	...
	public void shouldHaveHealth20() {
		Pet underTest = new RoboticDog("", "", 20, 0, 80);
		int health = underTest.getHealth();
	...
	public void shouldHaveTickIncreaseDryness() {
		Robotic underTest = new RoboticDog("", "", 50, 0, 10);
		underTest.tick();
		int dryness = underTest.getDryness();
	...
	public void shouldHaveBoredom10() {
		int boredom = 10;
		Pet underTest = new RoboticDog("", "", 0, boredom, 0);
	...
	public void shouldHaveNameAlan() {
		Pet underTest = new RoboticDog("Alan", "", 0, 0, 0);
		String name = underTest.getName();
	...
	public void shouldHaveDescriptionGoodBoy() {
		Pet underTest = new RoboticDog("", "Good boy", 0, 0, 0);
		String description = underTest.getDescription();
	...
	public void shouldHavePlayReduceBoredom() {
		Pet underTest = new RoboticDog("", "", 0, 100, 0);
		underTest.play();
	...
	public void shouldHaveTickDecreaseHealthIfDry120() {
		RoboticDog underTest = new RoboticDog("", "", 100, 0, 120);
		underTest.tick();
		int health = underTest.getHealth();
	...
	public void shouldHaveTickIncreaseHealthIfNothingsWrong() {
		RoboticDog underTest = new RoboticDog("", "", 50, 100, 100);
		underTest.tick();
		int health = underTest.getHealth();
		assertThat(health, is(100));
	}
